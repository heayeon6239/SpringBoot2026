...
export default function Signup() {
    ...
    // react 화면에서 입력한 자료(JSON형식)를 가지고 백앤드의 주소로 데이터를 넘겨주어야함(하지만 spring은 JSON을 받을 수 없음)
    ...
    // 이동할 때 사용하는 커스텀 훅
    const navigate = useNavigate(); // 커스텀 훅
    ...
    const signup = () =>{
        ...
        // JSON형태로 데이터 전송
        axios.post('/api/member/signup',{id:id, pw:pw, mail:mail, phone:phone}) // => JSON형태
        .then((res)=>{
